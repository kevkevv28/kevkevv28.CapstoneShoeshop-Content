        ...
        <div class="cart_inner">
            <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <div class="product_count mt-4">
                                    <input type="text" name="qty[]" id="sst_<?php echo $wishlist['product_id']; ?>" maxlength="12" value="<?php echo $wishlist['quantity_cart']; ?>" title="Quantity:" class="input-text qty" oninput="calculateTotalAndUpdate(<?php echo $wishlist['product_id']; ?>, <?php echo $wishlist['price']; ?>)">
                                    
                                    <div class="arrowsbtn">
                                        <!-- Updated the buttons to call the new functions -->
                                        <button onclick="increaseQuantity(<?php echo $wishlist['product_id']; ?>, <?php echo $wishlist['price']; ?>) ; updateTotalAmount()" class="increase items-count arrowup  border" type="button"><i class="fas fa-chevron-up"></i></button>
                                        <button onclick="decreaseQuantity(<?php echo $wishlist['product_id']; ?>, <?php echo $wishlist['price']; ?>) ; updateTotalAmount()"  class="reduced items-count arrowdown border" type="button"><i class="fas fa-chevron-down"></i></button>
                                    </div>
                                </div>
                            </td>
                            <td>
                ...
                <div class="d-flex justify-content-end my-4">
                    ...
                    <button type="submit" class="primary-btn addToCartBtn "name="save_multiple" >Check out</button>
